    ...
    useEffect(() => {
        ...
        const fetchRecommendedGames = async () => {
            try {
                ...
                if (isMounted) setRecommendedGames(data.data.slice(4, 12));
            } catch (error) {
            ...
            >
                {recommendedGames.map((game) => (
                    ...
                    >
                        {/* Glow Overlay */}
                        <div
                            className="absolute inset-0 bg-gradient-to-br from-cod-amber/10 to-cod-orange/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-0"/>
